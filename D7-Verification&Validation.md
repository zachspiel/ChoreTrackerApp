...
<h2>3. Validation (user evaluation)</h2>
...
I didn’t find it very well, the homepage is not positioned correctly on this phone. 
...
Comment about the quote on the homepage:
...
Yes, but not very well. But it is in the very early stages so it's not a big deal. 
...
UI is a bit basic. Not a huge fan of the color scheme
...
Would be a 4 or 5ish. Color scheme isn’t great. Higher res image would be good, and use the color theory and color wheel. Choose opposite colors and make a color palette that way.

**Please try and add an event to your calendar. How easy is it to find?**

Accidentally swiped event and deleted it. 
...
It is similar, but more involved and more features i.e. it is device independent so it wont have extreme transfer issues, you just need one account to use it.
